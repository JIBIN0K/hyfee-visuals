...
export default function CinematicComingSoon() {
  return (
    <main className="min-h-screen bg-black text-white flex items-center pt-32 pb-16">
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/"
              className="rounded-xl border border-white/10 px-8 py-4 hover:border-green-500 transition"
            >
              Back Home
            </Link>
