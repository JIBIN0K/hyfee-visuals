...
export default function ExclusivePreset() {
  return (
    <main className="bg-black text-white pt-32">
          ...
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-10">
                ...
                <h2 className="mt-3 text-6xl font-bold text-green-500">
                  ₹249
                </h2>
              </div>
            ...
            <div className="flex justify-center">
              <Image
                ...
                height={950}
                priority
                className="w-full max-w-md rounded-3xl border border-white/10 shadow-2xl shadow-green-500/20"
              />
            </div>
          </div>
        </Container>
      ...
      <section className="border-t border-white/10 py-24">
        <Container>
          <div className="mx-auto max-w-4xl rounded-3xl border border-green-500/20 bg-gradient-to-br from-[#171717] via-[#121212] to-[#090909] p-14 text-center">
