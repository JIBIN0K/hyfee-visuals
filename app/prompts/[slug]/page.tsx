    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black text-white pt-24">
      ...
      <section className="mx-auto max-w-6xl px-5 py-12 md:px-8 md:py-20">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="rounded-full border border-green-500/30 bg-green-500/10 px-4 py-2 text-xs font-medium tracking-wide text-green-300 md:text-sm">
            {prompt.category}
          </span>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {prompt.models.map((model) => (
              <span
                key={model}
                className="rounded-full border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm text-zinc-200 transition hover:border-green-500 hover:text-white"
              >
                {model}
              </span>
            ))}
        ...
        <div className="sticky top-20 z-20 mt-10 rounded-2xl border border-green-500/20 bg-zinc-950/90 p-5 backdrop-blur">
...
{prompt.prompt}
        ...
        <div className="mt-12">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            {[
              ...
              <div
                key={step.number}
                className="rounded-3xl border border-zinc-800 bg-zinc-900/60 p-6 transition-all duration-300 hover:border-green-500/50 hover:bg-zinc-900"
              >
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2">
            ...
            {relatedPrompts.slice(0, 4).map((item) => (
              ...
              <Link
                ...
                className="group overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 transition-all duration-300 hover:-translate-y-1 hover:border-green-500/50 hover:shadow-xl hover:shadow-green-500/10"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <span className="font-semibold text-green-400 transition group-hover:translate-x-1">
                      Explore →
                    </span>
        ...
        <div className="mt-24 rounded-3xl border border-green-500/20 bg-gradient-to-r from-green-950/30 to-zinc-900 p-8 text-center md:p-12">
          ...
          <div className="mt-10">
            ...
            <Link
              href="/prompts"
              className="inline-flex rounded-xl bg-gradient-to-r from-green-600 to-green-800 px-8 py-4 font-semibold text-white shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-105 hover:shadow-green-500/60"
            >
              Browse All Prompts
            </Link>
