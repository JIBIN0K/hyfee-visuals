  ...
  return (
    <section className="bg-black py-24 lg:py-32">
      <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-3xl border border-green-500/20 bg-gradient-to-br from-green-900/40 via-zinc-950 to-black p-10 shadow-2xl shadow-green-900/10 md:p-16">
          ...
          <div className="mt-12 flex flex-col justify-center gap-5 sm:flex-row">
            ...
            <a
              ...
              className="rounded-xl bg-gradient-to-r from-green-600 to-green-800 px-10 py-4 text-center text-base font-semibold text-white shadow-lg shadow-green-700/30 transition duration-300 hover:scale-105 hover:shadow-green-600/40"
            >
              📸 Book Your Shoot
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-xl border border-green-500 px-10 py-4 text-center text-base font-semibold text-green-300 transition duration-300 hover:bg-green-600 hover:text-white"
            >
              🎨 Editing Service
            </a>
