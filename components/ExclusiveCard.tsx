  ...
  return (
    <section className="bg-black py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-3xl border border-green-500/20 bg-gradient-to-br from-zinc-900 via-green-950/30 to-black p-8 md:p-14 shadow-2xl shadow-green-500/10">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-green-600 to-green-800 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-green-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-green-500/50"
              >
                Preview Presets
              </Link>
