  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 text-center sm:px-8 lg:px-12">
        ...
        {/* Small Badge */}
        <div className="mb-6 rounded-full border border-green-500/30 bg-green-500/10 px-5 py-2">
        ...
        <div className="mt-10 flex w-full flex-col justify-center gap-4 sm:w-auto sm:flex-row">
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-green-600 to-green-800 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-green-600/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-green-600/50"
          >
            📸 Book Your Shoot
          </a>
          ...
          <a
            href="#portfolio"
            className="inline-flex items-center justify-center rounded-xl border border-green-500/50 bg-black/20 px-8 py-4 text-base font-semibold text-green-200 backdrop-blur transition-all duration-300 hover:border-green-400 hover:bg-green-600/20 hover:text-white"
          >
            View Portfolio
          </a>
