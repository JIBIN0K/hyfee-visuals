    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="inline-flex rounded-full border border-green-500/30 bg-green-500/10 px-5 py-2">
          ...
          {services.map((service) => (
            ...
            <div
              ...
              className={`group relative flex flex-col rounded-3xl border p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${
                service.featured
                  ? "border-green-500/50 bg-gradient-to-b from-green-900/20 to-zinc-900 hover:shadow-green-500/20"
                  : "border-zinc-800 bg-zinc-900 hover:border-green-500/40 hover:shadow-green-500/10"
              }`}
            >

              {service.featured && (
                <span className="absolute right-5 top-5 rounded-full bg-green-600 px-3 py-1 text-[11px] font-medium text-white">
                  Most Popular
                </span>
              )}
              ...
              <a
                ...
                className={`mt-8 inline-flex items-center justify-center rounded-xl px-6 py-3 text-base font-semibold transition-all duration-300 ${
                  service.featured
                    ? "bg-gradient-to-r from-green-600 to-green-800 text-white hover:-translate-y-1"
                    : "border border-green-500 text-green-300 hover:bg-green-600 hover:text-white"
                }`}
              >
                {service.button}
              </a>
