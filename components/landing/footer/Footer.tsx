        ...
        <div className="grid gap-14 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div>
            ...
            <nav className="mt-6 flex flex-col gap-4">
              ...
              <Link
                href="/"
                className="text-zinc-400 transition hover:text-green-300"
              >
                Home
              </Link>
          ...
          <div>
            ...
            <div className="mt-6 flex gap-5">
              ...
              <a
                ...
                aria-label="Email"
                className="rounded-xl border border-white/10 p-3 text-2xl transition hover:border-blue-500 hover:text-blue-400"
              >
                <MdEmail />
              </a>
