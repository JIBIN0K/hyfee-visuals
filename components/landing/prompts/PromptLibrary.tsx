    ...
    <Section className="bg-black">
      <Container>
            ...
            <Card key={prompt.slug} className="group">
              ...
              <Link href={`/prompts/${prompt.slug}`} className="flex h-full flex-col">
                ...
                <div className="flex h-full flex-col p-7">
                  ...
                  <span className="text-sm uppercase tracking-wider text-green-300">
                    {prompt.category}
                  </span>
        ...
        <div className="mt-14 text-center">
          ...
          <Link
            href="/prompts"
            className="inline-flex rounded-xl border border-green-500 px-8 py-4 font-semibold text-green-300 transition hover:bg-green-600 hover:text-white"
          >
