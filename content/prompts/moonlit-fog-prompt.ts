const prompt = {
  slug: "moonlit-fog-prompt",

  title: "Moonlit Fog Prompt",

  description:
    "Transform any image into a premium ultra-realistic moonlit fog masterpiece with soft moonlight, atmospheric mist, and cinematic nighttime ambience while preserving the main subject perfectly.",

  category: "Atmospheric",

  image: "/images/prompts/moonlit-fog-prompt.jpg",
